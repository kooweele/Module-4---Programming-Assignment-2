## Plot 1 
## Question:    Have total emissions from PM2.5 decreased in the United States from 1999 to 2008? Using the base plotting system, make a plot showing the total 
...
plot1 <- function() {
        ...
        plot(sum_emissions_by_yr$year , sum_emissions_by_yr$total.pm25, type = "l", xlab ="Year", ylab = "Total PM25/Tonnes", pch = 23, main="Total PM2.5 (1999-2008)")
